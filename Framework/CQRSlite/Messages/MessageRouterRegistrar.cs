...
{
    public class MessageRouterRegistrar : IMessageRouteRegistrar
    {
        private readonly IServiceLocator _serviceLocator;

        public MessageRouterRegistrar(IServiceLocator serviceLocator)
        {
            ...
            foreach (var typesFromAssemblyContainingMessage in typesFromAssemblyContainingMessages)
            {
                ...
                foreach (var executorType in executorTypes)
                    foreach (var @interface in executorType.Interfaces)
                        InvokeHandler(registrar, @interface, executorType.Type);
            }
        }
        ...
        private void InvokeHandler(IHandlerRegistrar registrar, Type @interface, Type executorType)
        {
